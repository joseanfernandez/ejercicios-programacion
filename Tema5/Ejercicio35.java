...
*El programa debe pedir la altura. Se debe comprobar que la altura sea
*un número impar mayor o igual a 3, en caso contrario se debe mostrar un mensaje de error.
...
public class Ejercicio35 { // Clase principal
  public static void main(String[] args) {
    ...
    System.out.print("Introduce la altura de la X, debe ser un número impar mayor de 3: ");
    int h = s.nextInt();
    int altura = 1;
    int espadelante = 0;
    int espadetras = h - 2;
